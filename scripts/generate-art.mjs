...
import { bannerDay1, bannerDay2, bannerDay3 } from './art-banners.mjs'
import { scheduleIcons } from './art-schedule.mjs'
...
const banners = [save('banner-day1', bannerDay1()), save('banner-day2', bannerDay2()), save('banner-day3', bannerDay3())]
const schedIcons = scheduleIcons(save)
...
if (process.env.ART_PREVIEW) preview([kv, terrain, ...banners, ...schedIcons, ...guides, ...icons])
console.log('生成した素材:\n  ' + written.join('\n  '))
