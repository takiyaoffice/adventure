...
| 画面 | 内容 |
| --- | --- |
| ホーム | キービジュアル、TODAY'S ADVENTURE、各画面へのメニュー |
| スケジュール | DAY 1〜3 のタブと、日ごとのタイムラインカード |
| マップ | 仙台をもとにしたドット絵のワールドマップ。場所をタップすると詳細が出る |
| ミッション | 場所 / 体験 / 特別のミッション一覧。達成すると MISSION COMPLETE 演出が出る |

4画面すべてに共通フッターがあり、そこから相互に移動できます。
...
| `src/data/schedule.ts` | DAY 1〜3 の日付・タイトル・時刻ごとの予定 |
...
小さいほうに合わせて比例拡大しています。どの iPhone でも同じ見た目になります。
